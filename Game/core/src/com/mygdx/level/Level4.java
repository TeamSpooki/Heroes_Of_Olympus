...
//64,128,192,256,320,384,448,512,576,640,704,768,832,896,960,1024,1088,1152,1216,1280
        ...
        titan = new Enemy(TextureRegion.split(new Texture(Gdx.files.internal("Level4/KnightCaptain.png")), 64, 64), "Titan", 1, 15, 40);
        ...
        enemy1 = new Enemy(TextureRegion.split(new Texture(Gdx.files.internal("Level4/KnightArcher.png")), 64, 64), "Enemy1", 1, 5, 20);
...
/*
        ...
        enemies.add(enemy2);
*/
        enemy3 = new Enemy(TextureRegion.split(new Texture(Gdx.files.internal("Level4/KnightArcher.png")), 64, 64), "Enemy3", 1, 5, 20);
        ...
        enemy4 = new Enemy(TextureRegion.split(new Texture(Gdx.files.internal("Level4/KnightSpear.png")), 64, 64), "Enemy4", 1, 2, 10);
        enemy4.setPosition(MainGameScreen.WIDTH - 448, MainGameScreen.HEIGHT / 2 - 192);
        mapCollisions.add(new Location(MainGameScreen.WIDTH - 448, MainGameScreen.HEIGHT / 2 - 192));
        enemies.add(enemy4);

        enemy5 = new Enemy(TextureRegion.split(new Texture(Gdx.files.internal("Level4/KnightSpear.png")), 64, 64), "Enemy5", 1, 2, 10);
        ...
        enemy6 = new Enemy(TextureRegion.split(new Texture(Gdx.files.internal("Level4/KnightSpear.png")), 64, 64), "Enemy6", 1, 2, 10);
        enemy6.setPosition(MainGameScreen.WIDTH - 448, MainGameScreen.HEIGHT / 2 + 64);
        mapCollisions.add(new Location(MainGameScreen.WIDTH - 448, MainGameScreen.HEIGHT / 2 + 64));
        enemies.add(enemy6);
    }
}
