...
public class Level4 extends AbstractLevel {
    ...
    public Level4() {
        ...
        enemy2 = new Enemy(TextureRegion.split(new Texture(Gdx.files.internal("Level4/KnightArcher.png")), 64, 64), "Enemy2", 1, 5, 20);
        ...
        enemy3 = new Enemy(TextureRegion.split(new Texture(Gdx.files.internal("Level4/KnightSpear.png")), 64, 64), "Enemy3", 1, 2, 10);
